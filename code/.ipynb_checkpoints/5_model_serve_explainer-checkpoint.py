...
# Once again, we use the `ExplainedModel` helper class in `eligibility_explainer.py`.
...
# * **Name**: Explainer
# * **Description**: Explain loan eligibility prediction
...
# eligibility and create a LIME explainer explained instance and return that as JSON.
def explain(args):
