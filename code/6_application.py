...
# which displays eligibility predictions and explanations using the Model API deployed in
# Part 5
...
# * **Name**: Loan Eligibility Analysis App
...
# At this point, you will be able to open the Loan Eligibility Analysis App.
...
# The colors in the *Probability* column correspond to the prediction, with red loans being deemed more likely to be declined.
# The colors of the features show which are most important for each prediction.
# Deeper red indicates increased importance for predicting that a loan **will be declined**
# while deeper blue indicates incresed importance for predicting that a laon **will be accepted**.
#
...
# Here, you can see how adjusting any one of the features will change that loan's eligibility prediction.
#
...
em = ExplainedModel.load(model_name="loan_linear")
